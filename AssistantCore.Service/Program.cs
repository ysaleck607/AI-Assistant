...
// AssistantCore.Service is internal-only behind the BFF / trusted ingress.
// Do not process client-supplied X-Forwarded-* headers here. TLS enforcement is
// performed by Container Apps ingress (allowInsecure=false) and the public edge.
